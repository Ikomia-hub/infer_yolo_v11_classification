...
from infer_yolo_v11_classification.infer_yolo_v11_classification_process import InferYoloV11ClassificationParam
...
# --------------------
class InferYoloV11ClassificationWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferYoloV11ClassificationParam()
        else:
...
# --------------------
class InferYoloV11ClassificationWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_yolo_v11_classification"

    def create(self, param):
        # Create widget object
        return InferYoloV11ClassificationWidget(param, None)
